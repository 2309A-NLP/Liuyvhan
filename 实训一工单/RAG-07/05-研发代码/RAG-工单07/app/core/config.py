...
class Settings(BaseSettings):
    ...
    enable_query_classification: bool = Field(default=True, alias="ENABLE_QUERY_CLASSIFICATION")
    enable_synonym_expansion: bool = Field(default=True, alias="ENABLE_SYNONYM_EXPANSION")
    query_rewrite_model: str = Field(default="", alias="QUERY_REWRITE_MODEL")
    synonym_dict_path: str = Field(default="./data/synonym_dict.json", alias="SYNONYM_DICT_PATH")
    ...
    # 页眉页脚过滤：跳过页面顶部/底部 N% 的重复内容（水印、页眉、页码等）
